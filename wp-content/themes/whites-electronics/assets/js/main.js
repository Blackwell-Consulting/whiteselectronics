...
},{"../lib/cookie":10,"waitFor":14}],2:[function(require,module,exports){
...
},{"waitFor":14}],3:[function(require,module,exports){
$(function() {
...
},{"waitFor":14}],5:[function(require,module,exports){
$(function() {
...
},{"waitFor":14}],7:[function(require,module,exports){
var waitFor = require('waitFor');
...
},{"waitFor":14}],8:[function(require,module,exports){
var waitFor = require('waitFor');
...
},{"waitFor":14}],9:[function(require,module,exports){
var waitFor = require('waitFor');
...
},{"../lib/jquery-scrollto":11,"waitFor":14}],10:[function(require,module,exports){
/*!
...
waitFor('.js_detector-selector', function () {
  ...
  $form.find('.js_finish').on('click', function (e) {
    ...
    $form.add($resultsContainer).toggle();
  ...
  function showDetectorResults() {
    ...
    if ($detectors.length) {
      ...
      $('.detector-selector-result:not(.selected)').remove();
    }
    else
    {
  ...
  function showPersonalityProfile() {
    var levelAnswers = getAnswerValues($questions.filter('.question-tech-savvy, .question-frequency'));
    var selectedLevel = getFlags(levelAnswers);

    if (selectedLevel in levels) {
      var appealAnswers = getAnswerValues($questions.filter('.question-appeal'));
...
},{"waitFor":14}],16:[function(require,module,exports){
(function (global){
var $ = (typeof window !== "undefined" ? window['$'] : typeof global !== "undefined" ? global['$'] : null);
...
waitFor('.woocommerce-products-compare-compare-link', function () {
  ...
  $compareCheckBoxes.on('change', function(e) {
    if(typeof $.wc_products_compare_frontend != 'undefined') {
      ...
      $compareBtn.parent().toggleClass('active', comparedProducts.length > 1);
    }
  });
...
},{"../lib/magnific-popup.min":12,"waitFor":14}],17:[function(require,module,exports){
var waitFor = require('waitFor');
...
},{"sassqwatch":25,"waitFor":14}],18:[function(require,module,exports){
var waitFor = require('waitFor');
...
},{"waitFor":14}],19:[function(require,module,exports){
/**
...
},{"./elementify":19,"./extend":20,"./getData":22,"./preloader":23,"./sassqwatch":25}],25:[function(require,module,exports){
// Polyfills
require('./forEach');
...
},{"./forEach":21,"./responsiveImages":24}]},{},[17,5,2,1,3,6,7,8,9,4,13,18,15,16]);
